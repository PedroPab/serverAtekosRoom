...
const db = new MongoRepository('links') // Nombre de la colección en MongoDB

class LinkMongoRepository extends LinkRepository {
...
export default LinkMongoRepository
